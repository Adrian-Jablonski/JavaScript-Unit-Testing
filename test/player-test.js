...
describe("PLAYER METHODS", function() {
    describe("validateLocation", function() {
        var validateLocation = require("../game-logic/player-methods.js")
            .validateLocation;
        var player;
    ...
    describe("validateLocations", function() {
        var validateLocations = require("../game-logic/player-methods.js")
            .validateLocations;
        var player;
    ...
    describe("placeShip", function() {
        ...
        it("should throw an error if no direction is specified", function() {
            ...
            expect(handler).to.throw("Direction not provided");
        });
    });
});
